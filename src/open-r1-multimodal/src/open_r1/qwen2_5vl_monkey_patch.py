...
from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VLVisionFlashAttention2, apply_rotary_pos_emb_flashatt, flash_attn_varlen_func,Qwen2_5_VisionTransformerPretrainedModel
import torch
...
def monkey_patch_Qwen2_5_VisionTransformerPretrainedModel():
    Qwen2_5_VisionTransformerPretrainedModel.forward = qwen2_5vl_vision_flash_attn_forward
