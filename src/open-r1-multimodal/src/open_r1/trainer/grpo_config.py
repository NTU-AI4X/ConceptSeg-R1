...
class GRPOConfig(TrainingArguments):
    ...
    num_of_query: Optional[int] = field(
        default=8,
        metadata={
            "help": "num_of_query."
        },
    )
    is_grpo_train: Optional[bool] = field(
        default=None,
        metadata={
            "help": "is_grpo_train."
        },
    )
    load_lr_scheduler_states: Optional[bool] = field(
        default=True,
        metadata={
            "help": "load_lr_scheduler_states."
        },
    )
    load_optimizer_states: Optional[bool] = field(
        default=True,
        metadata={
            "help": "num_of_query."
        },
